...
<form action="../studentLoginAction.st" class="signUp" id="signupForm" method="post">
   <h1 class="signUpTitle">학생 로그인</h1>
   <input type="text" id="student_id" name="student_id" class="signUpInput" placeholder="아이디" autofocus required>
   <input type="password" id="student_password" name="student_password"class="signUpInput" placeholder="비밀번호" required>
